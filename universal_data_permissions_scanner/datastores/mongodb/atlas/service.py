...
class AtlasService:
    ...
    def get_custom_roles_by_project(
        self, project: Project, project_dbs_to_collections: Dict[str, List[str]]
    ) -> Dict[str, CustomRole]:
        ...
        return {
            entry["roleName"]: CustomRole.build_custom_role_from_response(entry, project_dbs_to_collections)
